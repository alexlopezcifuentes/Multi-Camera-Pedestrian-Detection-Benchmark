function Homography = readHomographyFile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   HOMOGRAPHY2 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   HOMOGRAPHY2 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Homography2 = importfile('Homography 1.txt', 1, 3);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/11/06 17:27:25
